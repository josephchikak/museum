...
return (
 <>
   <div className='w-[100%] min-h-[100vh] h-[100%] font-inter flex justify-between bg-background border-black border-t-[1px] flex-row p-10  overflow-hidden'>
     ...
     {/* <div className='flex justify-between flex-col'> */}
       ...
       <div className='p-10 grid grid-cols-3 w-[100%] h-fit gap-4'> 

          {
              pages.docs.map((page,i) => { 
                return (
                  <div id={page.id} key={page.id} className='flex flex-col justify-between p-8 gap-2 w-[40vw] h-[50vh] border-primary border-[1px] rounded-md bg-[#FFFDF5]'>
