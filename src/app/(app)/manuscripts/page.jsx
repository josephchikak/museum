...
const Pages = async() => {
  ...
  return (
    <>
      <div className='w-[100vw] h-[50vh] relative flex justify-between bg-background border-black border-t-[1px] flex-row p-8 '>

        <div className='flex justify-between flex-col'>

          <div className='h-fit w-fit text-primary flex flex-col gap-4 z-10 text-[1rem]'>
          <Image
